...
// Type: Green_Dragon_Writer.AboutBox1
...
namespace Green_Dragon_Writer
{
  ...
  public sealed class AboutBox1 : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.LabelProductName.Text = "Green Dragon Writer";
      ...
      this.LabelVersion.Text = "Version 4.0.0.0";
      ...
      this.LabelCopyright.Text = "Copyright Emil Sayahi Green Dragon";
      ...
      this.LabelCompanyName.Text = "Green Dragon";
